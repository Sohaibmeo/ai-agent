    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-100">
      <div className="w-full max-w-md px-6">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-xs text-slate-500">We&apos;ll walk you through your targets next.</p>
        </div>
        ...
        >
          ...
          <div className="mt-4 text-center text-[11px] text-slate-600">
            ...
            <Link to="/auth/login" className="text-emerald-600 hover:text-emerald-700">
              Sign in
            </Link>
          </div>
        </form>
