    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950">
      <div className="w-full max-w-md px-6">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-4 text-2xl font-semibold text-slate-50">Create your account</h1>
          <p className="mt-1 text-xs text-slate-400">We&apos;ll walk you through your targets next.</p>
        </div>
